...
DB_FILE="/home/brooke.allen/hypo/output/bigslice_output/result/data.db"      # Path to your data.db
OUTPUT_CSV="/home/brooke.allen/hypo/output/bigslice_output/bgc_class_counts.csv"  # Path to save CSV
