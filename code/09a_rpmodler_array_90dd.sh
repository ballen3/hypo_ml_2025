...
#SBATCH --job-name=rpmodeler_90dd_array_full_db_addl_1
#SBATCH -p ceres
#SBATCH -N 1
#SBATCH -n 1
...
#SBATCH -o /project/arsef/projects/hypo_ml_2025/logs/rpm_fulldb/%x.%j.%N.o
#SBATCH -e /project/arsef/projects/hypo_ml_2025/logs/rpm_fulldb/%x.%j.%N.e
...
DATA_DIR="/home/brooke.allen/hypo/data/full_db_addl_files/db_addl_fna"

# Timestamp-based run ID
RUN_ID=$(date +%Y%m%d_%H%M%S)_${SLURM_ARRAY_TASK_ID}
RUNDIR="/90daydata/arsef/db_addl_rpmodler/${RUN_ID}"
